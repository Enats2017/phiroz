    ...
    <div class="content sales-report">
      <table class="form">
        <tr>
          ...
          <td style="width:13%;display:none;"><?php echo $entry_doctor; ?>
      ...
      <table class="list">
        <thead>
          <tr>
            <td class="left" style="width:50%;"><?php echo $column_medicine_name; ?></td>
            <td class="left" style="width:25%;"><?php echo $column_quantity_share; ?></td>
          </tr>
        </thead>
        <tbody>
          <?php if ($owner_datas) { ?>
...
function filter() {
	url = 'index.php?route=report/medicine_stock_report&token=<?php echo $token; ?>';
...
function filter_export() {
  url = 'index.php?route=report/medicine_stock_report/export&token=<?php echo $token; ?>';
