    ...
    <div class="content sales-report">
      <table class="form">
        <tr>
          ...
          <td style="width:13%;"><?php echo 'Responsible Person Name'; ?>
          ...
          <td style="width:13%;display: none;"><?php echo 'Owner Email'; ?>
          ...
          <td style="text-align: right;">
            ...
            <a style="padding: 13px 25px;" onclick="filter_export();" id="export" class="button"><?php echo 'Export'; ?></a>
            <a style="padding: 13px 25px;" onclick="filter_mail();" id="export" class="button"><?php echo 'Send Mail'; ?></a>
          </td>
        </tr>
      </table>
      <?php /* ?>
...
function filter() {
  url = 'index.php?route=report/export&token=<?php echo $token; ?>';
...
function filter_export() {
  url = 'index.php?route=report/owner_statement/export&token=<?php echo $token; ?>';
...
function filter_mail() {
  url = 'index.php?route=report/owner_statement/sendMail&token=<?php echo $token; ?>';
