...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/report.png" alt="" /> <?php echo 'Surgery Report'; ?></h1>
    </div>
...
function filter() {
	url = 'index.php?route=report/horse_wise_sur&token=<?php echo $token; ?>';
...
function filter_export() {
  url = 'index.php?route=report/horse_wise_sur/export&token=<?php echo $token; ?>';
