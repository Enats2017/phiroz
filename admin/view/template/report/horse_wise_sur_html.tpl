  ...
  <table class="store" style="margin-bottom:0px;width:100%;" align="center">
    ...
    <tr>
      <td colspan="2">
        <b><?php echo 'Sir,';  ?></b>
        <br />
        <b><?php echo 'The Following horses have been Treated with Lameness and Surgery From ' . $from_date . ' to '. $to_date .' by ' . $doctor_name . ' in the past '.$custom_days.' days as follows';  ?></b>
      </td>
    </tr>
  </table>
  <table class="product">
