...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content sales-report">
      ...
      <table class="form">
        <tr>
          <td style="width:10%;"><?php echo $entry_date_start; ?>
            <input type="text" name="filter_date_start" value="<?php echo $filter_date_start; ?>" id="date-start" size="12" /></td>
          <td style="width:10%;"><?php echo $entry_date_end; ?>
          ...
          <td style="width:8%;"><?php echo $entry_doctor; ?>
          ...
          <td style="text-align: right;">
            ...
            <a style="padding: 13px 25px;" onclick="export_ptk();" id="export" class="button"><?php echo 'Export PTK'; ?></a>
            <a style="padding: 13px 25px;" onclick="export_lmf();" id="export_lmf" class="button"><?php echo 'Export LMF'; ?></a>
          </td>
        </tr>
      </table>
      <table class="list">
        <thead>
          <tr>
            ...
            <td class="center" style="width:3%;">
              LMF
              <input type="checkbox" onclick="$('input[name*=\'selected_lmf\']').attr('checked', this.checked);" />
            </td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="text-align: center;">
              <?php if ($order['selected_lmf']) { ?>
                <input type="checkbox" name="selected_lmf[]" value="<?php echo $order['horse_id']; ?>" checked="checked" />
              <?php } else { ?>
                <input type="checkbox" name="selected_lmf[]" value="<?php echo $order['horse_id']; ?>" />
              <?php } ?>
            </td>
...
function filter() {
	url = 'index.php?route=report/horse_wise_fifteen&token=<?php echo $token; ?>';
...
function filter_export() {
  url = 'index.php?route=report/horse_wise_fifteen/export&token=<?php echo $token; ?>';
...
function export_ptk(){
  $('#sel_ptk').append('<input type="hidden" name="filter_doctor" value="1" />');
  $('#form').submit();
}

function export_lmf(){
  $('#sel_ptk').append('<input type="hidden" name="filter_doctor" value="2" />');
  $('#form').submit();
}
//--></script> 
<?php echo $footer; ?>