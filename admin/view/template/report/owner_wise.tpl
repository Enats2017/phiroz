    ...
    <div class="content sales-report">
      ...
      <table class="list">
		...
		$i = 1; 
	  	$total = 0;
          ?>
          <?php foreach ($owner_wise as $order) { ?>
          <tr>
...
function filter() {
	url = 'index.php?route=report/owner_wise&token=<?php echo $token; ?>';
...
function filter_export() {
  url = 'index.php?route=report/owner_wise/export&token=<?php echo $token; ?>';
