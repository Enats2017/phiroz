    ...
    <div class="content sales-report">
      <table class="form" style="">
        <tr>
          ...
          <td style="width:15%;"><?php echo 'Is Surgery'; ?>
      ...
      <table class="list">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="left"><?php echo $res['medicine_price']; ?></td>
...
function filter() {
  url = 'index.php?route=report/medicine&token=<?php echo $token; ?>';
  ...
  var filter_surgery = $('select[name=\'filter_surgery\']').attr('value');
  
  if (filter_surgery) {
      url += '&filter_surgery=' + encodeURIComponent(filter_surgery);
  }
...
function filter_export() {
  url = 'index.php?route=report/medicine/export&token=<?php echo $token; ?>';
