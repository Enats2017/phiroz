...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/report.png" alt="" /> <?php echo 'Shock Wave Report'; ?></h1>
    </div>
...
function filter() {
	url = 'index.php?route=report/horse_wise_shock&token=<?php echo $token; ?>';
...
function filter_export() {
  url = 'index.php?route=report/horse_wise_shock/export&token=<?php echo $token; ?>';
