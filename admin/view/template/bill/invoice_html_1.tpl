...
<?php foreach ($final_datas as $fkey => $final_data) { ?>
  ...
  <div style="page-break-after: always;margin-left:30px;margin-right:10px;">
    ...
    <table class="product">
      ...
      <?php } ?>
      <tr>
        <td align="right" colspan="3"><b><?php echo 'Total Amount Rs'; ?>:</b></td>
        <td align="right"><?php echo my_money_format_1($medicine_total); ?></td>
      </tr>
      <tr>
        <td align="right" colspan="3"><b><?php echo 'Payable Amount as per share (' . $data['owner_share'] .' %) Rs'; ?>:</b></td>
        <td align="right"><?php echo my_money_format_1($data['owner_share_amount']); ?></td>
      </tr> 
    </table>
    <table class="store" style="margin-bottom:0px;">
      <tr>
...
<?php } ?>
<?php
function my_money_format_1($number) 
{ 
    //$number = '2953154.83';
