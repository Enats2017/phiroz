<?php
class ControllerReportTrainerWise extends Controller { 
	public function index() {  
		$this->language->load('report/trainer_wise');
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('report/trainer_wise', 'token=' . $this->session->data['token'] . $url, 'SSL'),
			'separator' => ' :: '
		);

		$this->load->model('report/common_report');

		$this->data['trainer_wise'] = array();
		...
		$results = $this->model_report_common_report->getTransaction_trainer($data);
		...
		$pagination->url = $this->url->link('report/trainer_wise', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->template = 'report/trainer_wise.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function export(){
		...
		if($trainer_wise){
			...
			$this->redirect($this->url->link('report/trainer_wise', 'token=' . $this->session->data['token'].$url, 'SSL'));
		}
	}
}
?>
