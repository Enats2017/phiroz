...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_treatments'] = $this->language->get('text_treatments');
		...
		$this->data['text_owner_bill'] = $this->language->get('text_owner_bill');
		...
		$this->data['text_medicine_stock_report'] = $this->language->get('text_medicine_stock_report');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['horse']  = $this->url->link('catalog/horse', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['owner']  = $this->url->link('catalog/owner', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['treatments'] = $this->url->link('catalog/treatments', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['medicine_vol'] = $this->url->link('report/medicine_vol', 'token=' . $this->session->data['token'], 'SSL');


			$this->data['horse_wise_tr'] = $this->url->link('transaction/horse_wise', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['debit'] = $this->url->link('transaction/debit', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['credit'] = $this->url->link('transaction/credit', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['bill_payment'] = $this->url->link('bill/bill_payment', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['owner_outstanding_report'] = $this->url->link('report/owner_outstanding', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['owner_change'] = $this->url->link('tool/owner_change', 'token=' . $this->session->data['token'], 'SSL');

			$this->data['medicine_stock_report'] = $this->url->link('report/medicine_stock_report', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['owner_statement_1'] = $this->url->link('bill/owner_statement', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['owner_bill'] = $this->url->link('reports/owner_bill', 'token=' . $this->session->data['token'], 'SSL');
			
			$from = date('Y-m-d');
			$datefrom = date('Y-m-d', strtotime($from . "-7 day"));
			$url .= '&filter_date_start=' . $datefrom;
			$url .= '&filter_date_end=' . date('Y-m-d');
			$url .= '&out_status=1';
			$this->data['horse_wise_shock'] = $this->url->link('report/horse_wise_shock', 'token=' . $this->session->data['token'].$url, 'SSL');
			$this->data['horse_wise_tread'] = $this->url->link('report/horse_wise_tread', 'token=' . $this->session->data['token'].$url, 'SSL');
			$this->data['horse_wise_endos'] = $this->url->link('report/horse_wise_endos', 'token=' . $this->session->data['token'].$url, 'SSL');
			$this->data['horse_wise_sur'] = $this->url->link('report/horse_wise_sur', 'token=' . $this->session->data['token'].$url, 'SSL');
			$this->data['owner_statement_email'] = $this->url->link('report/owner_wise_email', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['owner_statement1'] = $this->url->link('report/owner_statement', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['owner_statement_summ'] = $this->url->link('report/owner_statement_summ', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['owner_email_status'] = $this->url->link('report/owner_email_status', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['category_medicine_report'] = $this->url->link('report/medicine_report', 'token=' . $this->session->data['token'], 'SSL');
